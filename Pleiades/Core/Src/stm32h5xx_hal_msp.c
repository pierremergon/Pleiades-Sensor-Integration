...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_INP5
    */
    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_0|AA_LVL_Pin|LIPO_LVL_Pin);
...
void HAL_USART_MspDeInit(USART_HandleTypeDef* husart)
{
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PA8     ------> USART3_TX
    */
    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_7|VCP1_T_RX_Pin);

    HAL_GPIO_DeInit(VCP1_T_TX_GPIO_Port, VCP1_T_TX_Pin);
